...
**Status:** complete at repository and controlled-draft proof scope; Phase 3 and enforcement are not authorised

**Completion evidence:** PR #1740 merged from exact signed head `272eb82ccadf2542bc67ffb93202db9ca18c3a7a` as
merge commit `755814d7d226808051d16f9d17f80342326e6a2a`. Controlled draft PR #1742 exercised the merged advisory
at final head `02964c13633c3c2440684bc574b58e528b1e4618`; runs `33156842234` and `33156897196` produced byte-identical
...
`needs-human` / `contract.markers-invalid` result. Issue #1739 records the full evidence and is closed.
