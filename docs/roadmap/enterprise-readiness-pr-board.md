...
| H-P0-04           | Partially satisfied                  | Staging redacted PASS attached (`db_authz: PASS` + `run-30002002715` / #1528); remaining = operator closure runbook restricted review + named sign-off on #1525 | Publishing live role/topology details    |
