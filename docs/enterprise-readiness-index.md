...
| Blocked                              | No repository source-of-truth reconciliation blocker remains after this update. Release sign-off remains blocked until hosted promotion evidence, release-commit scanner/exception review, named operator sign-off, and DR restore rehearsal evidence are attached or approved. |
