...
|--------|-----|--------|-------------|
| architecture | [domains/architecture.md](domains/architecture.md) | 0 | 15 |
| api | [domains/api.md](domains/api.md) | 0 | 9 |
| persistence | [domains/persistence.md](domains/persistence.md) | 0 | 12 |
| ci-guardrails | [domains/ci-guardrails.md](domains/ci-guardrails.md) | 0 | 15 |
| rebuild-reconciliation | [domains/rebuild-reconciliation.md](domains/rebuild-reconciliation.md) | 0 | 7 |
