...
-- Lock expectation: ordinary CREATE INDEX blocks table writes; apply only through a separately reviewed
-- operator plan with a target-specific maintenance window.
...
-- Provider capability: not required.
