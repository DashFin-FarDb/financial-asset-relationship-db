...
- `analyze` - Run a Codacy analysis over a directory/files
  ...
  - `--gh-code-scanning-compat` [default: false] - Reduce issue severity by one level, **for non-security issues**, for compatibility with GitHub's code scanning feature.
