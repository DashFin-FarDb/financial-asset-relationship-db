...
class SchemaReportGenerator:
    ...
    """Schema Report Generator Module

    This module generates a markdown report for the financial asset relationship database, including schema overview, relationship statistics, calculated metrics, business rules, and optimization recommendations.
    """
