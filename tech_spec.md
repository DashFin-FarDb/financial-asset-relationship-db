...
| Gradio     | 6.9.0        | Legacy UI framework               |
...
| Gradio UI            | Legacy Python-native dashboard                             | Gradio 6.9.0, Plotly ≥6.0.0                     | Graph Engine via direct Python calls           |
