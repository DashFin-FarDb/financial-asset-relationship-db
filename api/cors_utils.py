...
def _is_valid_https_idn(origin: str) -> bool:
    """
    Validate that an HTTPS origin's hostname can be IDNA-encoded and that the resulting ASCII origin
    (including optional port) matches the module's HTTPS domain pattern.
