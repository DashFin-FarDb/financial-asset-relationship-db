...
def render_standing_brief(observations: list, *, as_of: str | None = None) -> str:
    ...
    by_domain = _group_latest_by_domain(observations)
    lines = [
...
def _group_latest_by_domain(observations: list) -> dict[str, list]:
    """Group latest observations under every domain they affect."""
