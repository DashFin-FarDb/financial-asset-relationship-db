...
def _latest_by_primary_ref(observations: list[Observation]) -> list[Observation]:
    ...
    for obs in observations:
        ...
        if existing is None or _prefer_observation(obs, existing):
            by_ref[obs.primary_ref] = obs
    return list(by_ref.values())


def _prefer_observation(candidate: Observation, existing: Observation) -> bool:
    """Return True when candidate should replace an existing observation."""
