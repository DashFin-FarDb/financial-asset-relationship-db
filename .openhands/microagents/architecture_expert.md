...
|--------|-----|--------|-------------|
| architecture | [/docs/compound/domains/architecture.md](/docs/compound/domains/architecture.md) | 93 | 27 |
| api | [/docs/compound/domains/api.md](/docs/compound/domains/api.md) | 12 | 35 |
| persistence | [/docs/compound/domains/persistence.md](/docs/compound/domains/persistence.md) | 6 | 19 |
