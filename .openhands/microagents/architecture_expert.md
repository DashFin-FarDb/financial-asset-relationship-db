...
|--------|-----|--------|-------------|
| architecture | [/docs/compound/domains/architecture.md](/docs/compound/domains/architecture.md) | 8 | 23 |
| api | [/docs/compound/domains/api.md](/docs/compound/domains/api.md) | 1 | 14 |
| persistence | [/docs/compound/domains/persistence.md](/docs/compound/domains/persistence.md) | 0 | 18 |
| ci-guardrails | [/docs/compound/domains/ci-guardrails.md](/docs/compound/domains/ci-guardrails.md) | 1 | 25 |
| rebuild-reconciliation | [/docs/compound/domains/rebuild-reconciliation.md](/docs/compound/domains/rebuild-reconciliation.md) | 0 | 11 |
