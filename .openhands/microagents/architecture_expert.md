...
|--------|-----|--------|-------------|
| architecture | [domains/architecture.md](domains/architecture.md) | 0 | 17 |
| api | [domains/api.md](domains/api.md) | 0 | 10 |
| persistence | [domains/persistence.md](domains/persistence.md) | 0 | 14 |
| ci-guardrails | [domains/ci-guardrails.md](domains/ci-guardrails.md) | 0 | 17 |
| rebuild-reconciliation | [domains/rebuild-reconciliation.md](domains/rebuild-reconciliation.md) | 0 | 8 |
