...
|--------|-----|--------|-------------|
| architecture | [domains/architecture.md](docs/compound/domains/architecture.md) | 0 | 20 |
| api | [domains/api.md](docs/compound/domains/api.md) | 0 | 11 |
| persistence | [domains/persistence.md](docs/compound/domains/persistence.md) | 0 | 17 |
| ci-guardrails | [domains/ci-guardrails.md](docs/compound/domains/ci-guardrails.md) | 0 | 20 |
| rebuild-reconciliation | [domains/rebuild-reconciliation.md](docs/compound/domains/rebuild-reconciliation.md) | 0 | 9 |
| deployment | [domains/deployment.md](docs/compound/domains/deployment.md) | 0 | 0 |
