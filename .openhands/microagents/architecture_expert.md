...
|--------|-----|--------|-------------|
| architecture | [domains/architecture.md](domains/architecture.md) | 0 | 14 |
| api | [domains/api.md](domains/api.md) | 0 | 8 |
| persistence | [domains/persistence.md](domains/persistence.md) | 0 | 11 |
| ci-guardrails | [domains/ci-guardrails.md](domains/ci-guardrails.md) | 0 | 14 |
