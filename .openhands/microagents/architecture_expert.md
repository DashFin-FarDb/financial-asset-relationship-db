...
|--------|-----|--------|-------------|
| architecture | [/docs/compound/domains/architecture.md](/docs/compound/domains/architecture.md) | 87 | 26 |
| api | [/docs/compound/domains/api.md](/docs/compound/domains/api.md) | 12 | 30 |
| persistence | [/docs/compound/domains/persistence.md](/docs/compound/domains/persistence.md) | 4 | 16 |
