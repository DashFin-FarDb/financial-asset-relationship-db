...
|--------|-----|--------|-------------|
| architecture | [domains/architecture.md](domains/architecture.md) | 0 | 13 |
| api | [domains/api.md](domains/api.md) | 0 | 7 |
| persistence | [domains/persistence.md](domains/persistence.md) | 0 | 10 |
| ci-guardrails | [domains/ci-guardrails.md](domains/ci-guardrails.md) | 0 | 13 |
| rebuild-reconciliation | [domains/rebuild-reconciliation.md](domains/rebuild-reconciliation.md) | 0 | 6 |
