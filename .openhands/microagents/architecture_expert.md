...
|--------|-----|--------|-------------|
| architecture | [domains/architecture.md](domains/architecture.md) | 0 | 7 |
| api | [domains/api.md](domains/api.md) | 0 | 2 |
| persistence | [domains/persistence.md](domains/persistence.md) | 0 | 5 |
| ci-guardrails | [domains/ci-guardrails.md](domains/ci-guardrails.md) | 0 | 7 |
| rebuild-reconciliation | [domains/rebuild-reconciliation.md](domains/rebuild-reconciliation.md) | 0 | 1 |
