...
|--------|-----|--------|-------------|
| architecture | [domains/architecture.md](domains/architecture.md) | 0 | 2 |
| api | [domains/api.md](domains/api.md) | 0 | 0 |
| persistence | [domains/persistence.md](domains/persistence.md) | 0 | 1 |
| ci-guardrails | [domains/ci-guardrails.md](domains/ci-guardrails.md) | 0 | 2 |
