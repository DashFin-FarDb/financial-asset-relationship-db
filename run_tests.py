...
def _has_control_chars(value: str) -> bool:
    """
    Determine whether the string contains any disallowed control characters.

    Parameters:
        value (str): The string to inspect.

    Returns:
        bool: True if `value` contains NUL, newline, or carriage return; False otherwise.
    """
...
def _validate_pytest_args(args: list[str]) -> list[str]:
    """
    Validate pytest command-line arguments by rejecting NUL, newline, or carriage return.
    ...
    Raises:
        ValueError: If any argument contains NUL, newline, or carriage return.
    """
    validated: list[str] = []
    for arg in args:
