...
- [ ] H-P0-04 ADR 0007 remediation tracked via [Database authorization closure](./database_authorization_closure.md) issue (or equivalent) and public redacted pass template attached
...
H-P0-04 operator path: [Database authorization closure runbook](https://github.com/DashFin-FarDb/financial-asset-relationship-db/blob/main/docs/runbooks/database-authorization-closure.md).
