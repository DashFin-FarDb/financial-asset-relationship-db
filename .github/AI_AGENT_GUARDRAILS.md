...
The canonical low-autonomy contract, scanner scope rules, artifact rules, GNC evidence boundary, and fixed-decision
requirements are maintained in [High-Risk Change Guardrails](../docs/HIGH_RISK_CHANGE_GUARDRAILS.md). Apply that
document before implementation; this dependency-focused file does not restate or narrow those requirements.
