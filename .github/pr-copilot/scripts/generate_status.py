...
def generate_markdown(status: PRStatus) -> str:
    ...
    Generate a complete PR report including PR metadata, review statistics, CI/check details, mergeability, a task checklist, and a timezone.utc timestamp footer.
...
---
*Last updated: {datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M:%S")} timezone.utc*
