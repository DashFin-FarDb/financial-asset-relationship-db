...
def generate_markdown(status: PRStatus) -> str:
    ...
    Generate a complete PR report including PR metadata, review statistics, CI/check details,
    mergeability, a task checklist, and a timezone.utc timestamp footer.
...
def write_output(content: str) -> None:
    """Write the PR Markdown report to configured outputs.
