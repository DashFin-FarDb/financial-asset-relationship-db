...
class TestTypesPyYAMLVersionConstraint:
    ...
    def test_types_pyyaml_has_version_constraint(
        self, requirements_dict: Dict[str, str]
    ):
        """Test that types-PyYAML has a version constraint."""
        assert "types-PyYAML" in requirements_dict, "types-PyYAML should be present"

        version_spec = requirements_dict["types-PyYAML"]
        assert version_spec.strip(), "types-PyYAML should have a version constraint"
    ...
    def test_types_pyyaml_minimum_version_6(self, requirements_dict: Dict[str, str]):
        ...
        assert ">=6.0" in version_spec, "types-PyYAML should require version >=6.0.0"
