...
FROZEN_ROADMAP_BODY_SHA256 = "b5f590f8fa72413b43a165566e4274a5ad2db8f58d93d8ef7a8e1d24ccbf67ae"  # DevSkim: ignore all
...
def test_cq03d_progress_preserves_separate_authority_and_history_only_boundary() -> None:
    ...
    assert "**Last updated:** 2026-09-01" in roadmap
