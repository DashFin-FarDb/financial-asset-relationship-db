...
class TestCodeSherlockConfigFile:
    ...
    def test_target_branches_is_list(
        self, codesherlock_config: Dict[str, Any]
    ) -> None:
...
class TestCodeSherlockConfigContent:
    ...
    def test_preferred_characteristics_are_strings(
        ...
        for characteristic in codesherlock_config[
...
class TestCodeSherlockConfigEdgeCases:
    ...
    def test_no_whitespace_in_values(
        self, codesherlock_config: Dict[str, Any]
    ) -> None:
        for branch in codesherlock_config["target_branches"]:
    ...
    def test_yaml_indentation_consistency(
        self, codesherlock_config_path: Path
    ) -> None:
...
class TestCodeSherlockConfigDocumentation:
    ...
    def test_sections_are_documented(
        ...
        for key in (
            ...
            assert any(
                line.strip().startswith("#") for line in preceding
            )
