...
class TestDataFetcherWithFallback:
    ...
    def test_fetcher_with_custom_fallback():
        ...
        def custom_factory():
            """
            Provide a fallback AssetRelationshipGraph prepopulated with custom assets and relationships.

            Returns:
                AssetRelationshipGraph: A graph instance configured as the custom fallback dataset.
            """
            return custom_graph
...
class TestDataConsistency:
    ...
    def test_graph_clone_independence():
        """
        Verify that two independently created AssetRelationshipGraph instances do not share state: mutating one graph does not affect the other.
        """
