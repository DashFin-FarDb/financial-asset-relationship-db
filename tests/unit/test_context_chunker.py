...
# Make context_chunker importable from .github/scripts
_scripts_dir = Path(__file__).parent.parent.parent / ".github" / "scripts"
if str(_scripts_dir) not in sys.path:
    sys.path.insert(0, str(_scripts_dir))

from context_chunker import ContextChunker  # noqa: E402
