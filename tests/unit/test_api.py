...
class TestAPIErrorResponses:
    ...
    def test_500_error_has_detail_field(self, mock_graph_instance, client):
        ...
        type(mock_graph_instance).assets = PropertyMock(side_effect=Exception("Test error"))
...
class TestAPIRegressionCases:
    ...
    @patch("api.main.graph")
    def test_visualization_data_coordinates_are_numbers(self, mock_graph_instance, client, mock_graph):
