...
class TestCacheCorruptionRegression:
    ...
    def test_real_data_fetcher_handles_corrupted_cache_gracefully(
        mock_get_yfinance, _mock_ticker
    ):
    ...
    @patch("src.data.real_data_fetcher.yf.Ticker")
    @patch("src.data.real_data_fetcher._get_yfinance")
    def test_fallback_creates_valid_empty_graph_on_total_failure(
        mock_get_yfinance, mock_ticker
    ):
