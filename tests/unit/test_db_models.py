...
def db_session(tmp_path):
    ...
    Initializes the database schema at tmp_path / "test.db", yields an active Session for tests, and
    ensures the session is closed and the engine disposed after use.

    Parameters:
        tmp_path (pathlib.Path): Temporary directory fixture; the SQLite database file will be
        created at `tmp_path / "test.db"`.
