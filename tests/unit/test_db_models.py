...
def db_session(tmp_path):
    ...
    Initializes the database schema at tmp_path / "test.db", yields an active
    Session for tests, and ensures cleanup after use.

    Parameters:
        tmp_path (pathlib.Path): Temporary directory fixture for the SQLite
            database file.
