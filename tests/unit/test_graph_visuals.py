...
class DummyGraph(AssetRelationshipGraph):
    def __init__(self, relationships):
        ...
        """
        Initialize the DummyGraph with a mapping of relationships.
        
        Parameters:
            relationships (dict): Mapping from source asset ID (str) to a list of relationship tuples.
                Each tuple must be (target_asset_id: str, relation_type: str, weight: float).
                The mapping is stored on the instance as provided (no deep copy is performed).
        """
        super().__init__()
    ...
    def get_3d_visualization_data_enhanced(self):
        """
        Generate synthetic 3D visualization data for the graph's assets.
