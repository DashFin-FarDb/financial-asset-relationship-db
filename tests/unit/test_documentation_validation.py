...
class TestDependencyMatrix:
    ...
    def test_dependency_matrix_has_generated_timestamp(self, dependency_matrix_content: str) -> None:
        """
    ...
    def test_dependency_matrix_has_summary_section(self, dependency_matrix_content: str) -> None:
        """Test that dependencyMatrix.md has Summary section."""
        assert "## Summary" in dependency_matrix_content

    def test_dependency_matrix_has_file_count(self, dependency_matrix_content: str) -> None:
    ...
    def test_dependency_matrix_has_file_types(self, dependency_matrix_content: str) -> None:
        ...
        assert file_types.issubset(allowed_types), f"Unexpected file types: {file_types - allowed_types}"

    def test_dependency_matrix_has_file_type_distribution(self, dependency_matrix_content: str) -> None:
        """Test that File Type Distribution section exists."""
        assert "## File Type Distribution" in dependency_matrix_content

    def test_dependency_matrix_file_counts_match(self, dependency_matrix_content: str) -> None:
        ...
        assert summed == total_count, f"Sum of file type counts ({summed}) does not match total ({total_count})"

    def test_dependency_matrix_has_key_dependencies_section(self, dependency_matrix_content: str) -> None:
        """Test that Key Dependencies by Type section exists."""
        assert "## Key Dependencies by Type" in dependency_matrix_content

    def test_dependency_matrix_language_sections_exist(self, dependency_matrix_content: str) -> None:
    ...
    def test_dependency_matrix_dependency_format(self, dependency_matrix_content: str) -> None:
    ...
    def test_dependency_matrix_no_empty_dependency_sections(self, dependency_matrix_content: str) -> None:
    ...
    def test_dependency_matrix_markdown_formatting(self, dependency_matrix_lines: list[str]) -> None:
        ...
        for index, line in enumerate(dependency_matrix_lines, start=1):
            if line.startswith("#"):
                ...
                if match:
                    _, text = match.groups()
                    if text:
                        assert text.startswith(" "), f"Line {index}: Heading should have space after #: {line}"
...
class TestSystemManifest:
    ...
    def test_system_manifest_has_project_overview(self, system_manifest_content: str) -> None:
        """Assert presence of Project Overview section."""
        assert "## Project Overview" in system_manifest_content

    def test_system_manifest_has_project_name(self, system_manifest_content: str) -> None:
    ...
    def test_system_manifest_has_project_description(self, system_manifest_content: str) -> None:
    ...
    def test_system_manifest_has_created_timestamp(self, system_manifest_content: str) -> None:
    ...
    def test_system_manifest_has_current_phase(self, system_manifest_content: str) -> None:
        """Test that Current Phase section exists."""
        assert "## Current Phase" in system_manifest_content

    def test_system_manifest_has_last_updated(self, system_manifest_content: str) -> None:
    ...
    def test_system_manifest_has_project_structure(self, system_manifest_content: str) -> None:
    ...
    def test_system_manifest_file_counts(self, system_manifest_content: str) -> None:
        ...
        for count_str, file_type in matches:
            assert int(count_str) >= 0, f"File count for {file_type} should be non-negative"

    def test_system_manifest_has_dependencies_section(self, system_manifest_content: str) -> None:
        """Verify Dependencies section exists."""
        assert "## Dependencies" in system_manifest_content

    def test_system_manifest_has_directory_structure(self, system_manifest_content: str) -> None:
        """Verify Project Directory Structure section exists."""
        assert "## Project Directory Structure" in system_manifest_content

    def test_system_manifest_directory_structure_format(self, system_manifest_content: str) -> None:
        ...
        section = system_manifest_content.split("## Project Directory Structure", 1)[1].split("##", 1)[0]

        assert "📂" in section, "Directory entries should include 📂 emoji"
        assert "📄" in section, "File entries should include 📄 emoji"

    def test_system_manifest_has_language_dependency_sections(self, system_manifest_content: str) -> None:
    ...
    def test_system_manifest_markdown_formatting(self, system_manifest_lines: list[str]) -> None:
        ...
        for index, line in enumerate(system_manifest_lines[:500], start=1):
            if line.startswith("#"):
                ...
                if match:
                    ...
                    assert content.startswith(" "), f"Line {index}: Heading should have space after #: {line}"
