...
def sample_user():
    ...
    Returns:
        UserInDB: A UserInDB populated with username "testuser", email
            "test@example.com", full_name "Test User", disabled False, and a
...
class TestUserProfileTypedDict:
    ...
    def test_user_profile_has_expected_fields(self):
        """Ensure UserProfile TypedDict has expected profile annotations."""
    ...
    def test_user_profile_total_false_makes_all_keys_optional(self):
        """Ensure UserProfile total=False makes all keys optional."""
