...
def test_bench_asset_model_creation(benchmark):
    ...
    def _():
        Equity(
            ...
            price=150.0, market_cap=2.4e12, pe_ratio=25.5,
            dividend_yield=0.005, earnings_per_share=5.89,
        )
        Bond(
            id="BOND1", symbol="B1", name="Corp Bond",
            asset_class=AssetClass.FIXED_INCOME, sector="Technology",
            price=102.5, yield_to_maturity=0.025, coupon_rate=0.02,
        ...
        Commodity(
            ...
            price=2050.0, contract_size=100, volatility=0.15,
        )
        Currency(
            id="EUR", symbol="EUR", name="Euro",
            asset_class=AssetClass.CURRENCY, sector="Forex",
            price=1.10, exchange_rate=1.10, country="EU",
